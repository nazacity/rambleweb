...
const privacy = () => {
  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            the Company downloaded by You on any electronic device, named Ramble
          </p>
        </li>
        <li>
          <p>
            ...
            this Agreement) refers to NAZACITY Co.,Ltd., 471 Ratchadapisek
            Dindang Bangkok.
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: ramblemarathon@gmail.com</p>
        </li>
        <li>
          <p>By phone number: +66881493995</p>
        </li>
      </ul>
    </div>
  );

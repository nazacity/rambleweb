...
import { setAdminMenuIndex } from '../../../../../redux/actions/navigationActions';
...
const ElevateAppBar = (props) => {
  ...
  const adminMenuIndex = useSelector(
  ...
  const handleChange = (event, newValue) => {
    dispatch(setAdminMenuIndex(newValue));
  };
    ...
    <Fragment>
      <Toolbar>
        ...
        >
          ...
          >
            <Tab
              label={t('adminnavigation.partner')}

              ...
              <Fragment>
                <div>
                  ...
                  <Collapse in={open.finished} collapsedHeight={80}>
                    <Grid container style={{ width: 320 * 4, paddingLeft: 15 }}>
            ...
            {view === 'list' && (
              <Fragment>
                <div>
                  {activityState('finished')}
                  <Collapse in={open.finished} collapsedHeight={80}>
                    <Grid container style={{ width: 320 * 2, paddingLeft: 10 }}>
                      {activitiesByState.finished.map((activity, index) => {
                        return (
                          <Grid
                            item
              ...
              <Fragment>
                <div>
                  ...
                  <Collapse in={open.finished} collapsedHeight={80}>
                    <Grid
                      container
                      style={{ width: 320, padding: 5, paddingLeft: 10 }}
                    >
                      {activitiesByState.finished.map((activity, index) => {
                        return (
                          <Grid
                ...
                <div>
                  {activityState('cancel')}
                  <Collapse in={open.cancel} collapsedHeight={80}>
                    <Grid container style={{ width: 320, paddingLeft: 10 }}>
                      {activitiesByState.cancel.map((activity, index) => {
                        return (
